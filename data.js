...
const TENT_MODELS = [
  ...
  // ── 국내 인스타 인기 브랜드 (웹 조사 2026.07 — 어썸홀리데이·백컨트리) ──
  ["Awesome Holiday","래디언스 EX",2.0,3,55,"24",0,"국산","실리콘원단","더블월","인스타인기"],
  ["Awesome Holiday","스위프트 UL",1.25,3,45,"12",0,"국산","UL","초경량","실리콘원단"],
  ["Awesome Holiday","원",0.95,3,38,"1",0,"국산","싱글월","미니멀"],
  ["Backcountry","재너두 1.5 익스페디션",1.45,4,75,"1",0,"국산","동계","익스페디션","DAC폴"],
  ["Backcountry","세틀라이트",1.9,4,85,"2",0,"국산","동계","DAC폴","프리미엄"],
  ["Backcountry","240 쉘터",1.6,3,55,"23",0,"국산","쉘터","비자립"],
  ["Backcountry","오리손 얼티메이트 돔 쉘터",3.2,3,70,"34",0,"국산","돔쉘터","거주성"],
];
...
const BRAND_KR = {
  ...
  "Intex":"인텍스","Awesome Holiday":"어썸홀리데이","Backcountry":"백컨트리","Polaris":"폴라리스"
};
...
const TRIPS = [
  ...
  { name:"청옥산 육백마지기", lat:37.353, lng:128.624, date:"2026.06", people:["세아","민지","지우"],
    note:"고랭지 초원 야생화·별밤. 차박 성지에서 감성 1박", photo:"", insta:"" },
  { name:"민둥산", lat:37.283, lng:128.755, date:"2025.10", people:["준호","도현"],
    note:"가을 억새 능선. 정선 은빛 물결 속 1박", photo:"", insta:"" },
  { name:"덕유산 향적봉", lat:35.860, lng:127.747, date:"2025.12", people:["도현","준호","지우"],
    note:"상고대 설경 종주. 대피소 베이스 겨울 산행", photo:"", insta:"" },
  { name:"비슬산", lat:35.712, lng:128.523, date:"2025.04", people:["세아","민지"],
    note:"참꽃 군락 붉은 능선. 봄 시즌 인생샷 박지", photo:"", insta:"" },
];

// ── 지역(시·군) 대략 중심 좌표 — 박지 지도 배치용 (핀은 지역 대략치, 정확 위치는 팝업의 지도 링크) ──
const REGION_GEO = {
  "강원 강릉":[37.75,128.88],"강원 동해":[37.52,129.11],"강원 삼척":[37.45,129.17],"강원 양양":[38.07,128.62],
  "강원 영월":[37.18,128.46],"강원 원주":[37.34,127.92],"강원 인제":[38.07,128.17],"강원 정선":[37.38,128.66],
  "강원 춘천":[37.88,127.73],"강원 태백":[37.16,128.99],"강원 평창":[37.55,128.39],"강원 홍천":[37.70,127.89],"강원 횡성":[37.49,127.98],
  "경기 가평":[37.83,127.51],"경기 남양주":[37.64,127.22],"경기 안산":[37.28,126.60],"경기 양평":[37.49,127.49],"경기 포천":[37.89,127.20],"경기 화성":[37.08,126.70],
  "경남 거제":[34.85,128.62],"경남 밀양":[35.50,128.75],"경남 통영":[34.78,128.38],"경남 함양":[35.52,127.73],"경남 합천":[35.57,128.17],
  "경북 봉화":[36.89,128.73],"경북 울진":[36.99,129.30],"경북 청도":[35.65,128.73],
  "대구 달성":[35.70,128.43],"부산 강서":[35.05,128.84],"서울 마포":[37.55,126.90],"울산 울주":[35.52,129.20],
  "인천 옹진":[37.10,126.05],"인천 중구":[37.38,126.38],
  "전남 고흥":[34.61,127.28],"전남 신안":[34.83,126.11],"전남 완도":[34.31,126.75],"전남 장성":[35.30,126.79],
  "전남 장흥":[34.68,126.91],"전남 진도":[34.49,126.26],"전남 해남":[34.57,126.60],
  "전북 고창":[35.43,126.70],"전북 군산":[35.97,126.60],"전북 남원":[35.42,127.39],"전북 무주":[36.01,127.66],
  "전북 순창":[35.37,127.14],"전북 장수":[35.65,127.52],"전북 진안":[35.79,127.42],
  "제주":[33.40,126.55],"제주 서귀포":[33.28,126.56],
  "충남 금산":[36.11,127.49],"충남 보령":[36.33,126.61],"충남 서천":[36.08,126.69],"충남 태안":[36.75,126.30],"충남 아산":[36.79,127.00],
  "충북 괴산":[36.82,127.79],"충북 단양":[36.98,128.37],"충북 보은":[36.49,127.73],
  // 도(道) 폴백
  "강원":[37.8,128.2],"경기":[37.4,127.2],"경남":[35.3,128.4],"경북":[36.4,128.7],"전남":[34.9,126.9],
  "전북":[35.7,127.1],"충남":[36.5,126.8],"충북":[36.8,127.7],"서울":[37.55,126.98],"인천":[37.45,126.5],
  "부산":[35.15,129.0],"대구":[35.87,128.6],"울산":[35.54,129.3],"제주도":[33.4,126.5],"_default":[36.5,127.9],
};
function geoForSpot(s){
  const parts = String(s.region||'').split(/\s+/);
  const prov = (parts[0]||'').split('·')[0];
  const gu = parts[1] ? parts[1].split('·')[0] : '';
  const base = REGION_GEO[gu?prov+' '+gu:prov] || REGION_GEO[prov] || REGION_GEO['_default'];
  let h=0; for(const ch of String(s.name)) h=(h*31+ch.charCodeAt(0))%10000;   // 이름 기반 결정적 지터(겹침 방지)
  const jx=((h%100)/100-0.5)*0.05, jy=((Math.floor(h/100)%100)/100-0.5)*0.05;  // ~±2.5km
...
// ── 오토캠핑 장비 카탈로그 ──
const CAMP_GEAR_CATS = [
  "대형텐트","타프","테이블·체어","야전침대·침구","화로대",
  "버너·키친","수납·운반","난방·전원","설영·정리","물통·위생",
  "랜턴","아이스박스","의류"
];
const _CAMP_RAW = {
  "대형텐트":[
    ...
    ["Polaris","타우루스 베타 리빙쉘",45,0,"리빙쉘","국산","인스타인기"],
    ["Polaris","P1 TPU 원터치 쉘터",25,1,"원터치","투명창","감성"],
  ],
  "타프":[
    ...
    ["Backcountry","실타프3 사각",12,0,"국산","백패킹미니","실리콘"],
  ],
  "테이블·체어":[
  ...
  "야전침대·침구":[
    ["Helinox","코트 원 컨버터블",38,0,"야전침대","경량","프리미엄"],
    ["Helinox","코트 맥스 컨버터블",52,0,"야전침대","와이드","프리미엄"],
    ["Snow Peak","하이텐션 코트",42,0,"야전침대","일본","스테디셀러"],
    ["Coleman","트레일헤드 II 코트",8,1,"야전침대","튼튼함","가성비"],
    ["Kovea","이지 코트",9,1,"야전침대","국산","입문"],
    ["Naturehike","XJC03 코트",10,1,"야전침대","경량","가성비"],
    ["DOD","백 인 베드",13,0,"야전침대","수납간편","감성"],
    ["Ogawa","하이앤로우 코트",28,0,"야전침대","높이조절","일본"],
    ["KingCamp","폴딩 캠핑 코트",7,1,"야전침대","가성비","패밀리"],
    ["Decathlon","Quechua 캠프 베드",8,1,"야전침대","입문","가성비"],
    ["Exped","메가매트 듀오 10",42,0,"자충매트","더블","숙면"],
    ["Therm-a-Rest","몬도킹 3D",32,0,"자충매트","두꺼움","사계절"],
    ["NEMO","로머 더블",38,0,"자충매트","더블","편안함"],
    ["Sea to Summit","컴포트 디럭스 SI",28,0,"자충매트","두꺼움","패밀리"],
    ["Coleman","컴포트 에어베드",6,1,"에어베드","입문","가성비"],
    ["Intex","듀라빔 에어매트 퀸",5,1,"에어베드","전동펌프","가성비"],
    ["Snow Peak","SS 싱글 침낭",7,1,"침낭","사각","입문"],
    ["Coleman","퍼포머 III C10",5,1,"침낭","사각","여름"],
    ["Kovea","컴포트 침낭",6,1,"침낭","국산","가성비"],
    ["Pendleton","울 캠프 블랭킷",18,0,"블랭킷","감성","보온"],
  ],
  "화로대":[
  ...
  "수납·운반":[
    ["Coleman","아웃도어 웨건",12,1,"웨건","스테디셀러","가성비"],
    ["DOD","알루미늄 캐리웨건",18,0,"웨건","감성","대용량"],
    ["Naturehike","폴딩 캠핑 웨건",8,1,"웨건","입문","가성비"],
    ["Snow Peak","쉘프 컨테이너 25",18,0,"수납박스","스틸","감성"],
    ["Snow Peak","쉘프 컨테이너 50",23,0,"수납박스","대용량","스틸"],
    ["Thor","라지 토트 53L",7,1,"수납박스","방수","스테디셀러"],
    ["Stanley","클래식 런치박스",9,0,"수납박스","레트로","감성"],
    ["Helinox","테이블 사이드 스토리지",5,0,"오거나이저","경량","프리미엄"],
    ["Minimworks","인디언 행어 M",9,0,"행어","감성","키친정리"],
    ["Hang Out","로그 캐리어",8,0,"장작가방","감성","화로"],
    ["Petromax","파이어우드 백",7,0,"장작가방","캔버스","튼튼함"],
    ["Kovea","멀티 기어백 L",4,1,"기어백","국산","가성비"],
    ["Kazmi","멀티 하드케이스",5,1,"하드케이스","국산","수납"],
    ["Oregonian Camper","세미하드 기어백",7,0,"기어백","수납분리","감성"],
    ["Snowline","폴딩 쉘프 3단",6,1,"쉘프","국산","정리"],
    ["KZM","캠핑 폴딩 박스",3,1,"폴딩박스","입문","가성비"],
    ["Campingmoon","IGT 수납가방",4,1,"수납가방","IGT","가성비"],
    ["Decathlon","Quechua 방수 더플 80L",6,1,"더플백","방수","대용량"],
  ],
  "난방·전원":[
  ...
  "설영·정리":[
    ["Snow Peak","그라운드시트",8,0,"그라운드시트","텐트보호","정품"],
    ["Coleman","2룸 텐트 리빙시트",7,1,"리빙시트","가성비","거실형"],
    ["Ogawa","PVC 멀티시트",12,0,"그라운드시트","방수","일본"],
    ["DOD","캠핑 카페트",10,0,"텐트카페트","감성","거실형"],
    ["Kazmi","방염 매트",5,1,"방염매트","화로","국산"],
    ["Uniflame","스테인리스 팩 30cm",4,0,"팩","강풍","스테디셀러"],
    ["Snow Peak","솔리드 스테이크 30",5,0,"팩","강풍","단조"],
    ["Campingmoon","단조팩 세트",3,1,"팩","가성비","입문"],
    ["Snow Peak","펙 해머 Pro.C",8,0,"망치","동헤드","프리미엄"],
    ["Kovea","팩 해머",2,1,"망치","국산","가성비"],
    ["Helinox","타프 폴 280",12,0,"타프폴","경량","프리미엄"],
    ["Minimworks","폴대 240",7,0,"타프폴","국산","감성"],
    ["Nite Ize","캠잼 로프 타이트너",2,0,"스트링","장력조절","정리"],
    ["Atwood Rope","파라코드 30m",2,1,"스트링","가성비","보수"],
    ["Coleman","텐트 입구 발매트",2,1,"발매트","생활정리","입문"],
    ["DOD","트래시 스탠드",5,0,"쓰레기스탠드","감성","정리"],
    ["Belmont","화로 재받이 백",4,0,"애쉬백","화로정리","방염"],
    ["Naturehike","타프 클립 세트",1,1,"타프클립","가성비","보수"],
  ],
  "물통·위생":[
    ["Stanley","워터저그 7.5L",8,0,"워터저그","보냉","스테디셀러"],
    ["Igloo","스포츠 롤러 워터저그 5갤런",9,1,"워터저그","대용량","가성비"],
    ["DOD","지미니 탱크",7,0,"물통","감성","손씻기"],
    ["Hydrapak","시커 6L",6,0,"물백","접이식","경량"],
    ["Sea to Summit","키친 싱크 10L",4,0,"설거지통","접이식","캠프키친"],
    ["Naturehike","접이식 설거지통",2,1,"설거지통","가성비","입문"],
    ["Coleman","캠핑 샤워백",3,1,"샤워백","태양열","여름"],
    ["Kovea","휴대용 샤워기",5,1,"샤워기","국산","물놀이"],
    ["Ozark Trail","샤워 텐트",8,1,"샤워텐트","탈의","가성비"],
    ["Thetford","포르타 포티 345",18,0,"간이화장실","RV","장박"],
    ["Dometic","휴대용 변기 976",20,0,"간이화장실","프리미엄","차박"],
    ["Snow Peak","식기 건조망",4,0,"건조망","키친정리","감성"],
    ["Campingmoon","키친 드라잉랙",3,1,"식기랙","가성비","정리"],
    ["KZM","멀티 워시백",3,1,"세면가방","국산","수납"],
    ["Dr.Bronner's","퓨어 캐스틸 솝",2,0,"세제","다목적","친환경"],
    ["Cleanwaste","휴대용 화장실 키트",4,0,"위생키트","비상","노지"],
  ],
  "의류":[
...
// 크루 멤버 (실제 멤버 합류 시 이 배열만 고치면 됩니다)
const CREW_MEMBERS = [
  { name:"준호", role:"크루장",     tag:"솔캠 · UL",     desc:"백패킹 8년차. 짐 무게 재는 게 취미. 첫 참여도 편하게 도와드려요." },
  { name:"세아", role:"감성 담당",   tag:"섬 · 친목",     desc:"자차 없이 대중교통 섬백패킹 전문. 불멍과 사진 담당이에요." },
  { name:"도현", role:"동계 대장",   tag:"오지 · 헤비",   desc:"겨울 설능이 제철. 안전·보온 장비 잔소리는 제가 맡습니다." },
  { name:"민지", role:"살림 담당",   tag:"입문 · 친목",   desc:"공동장비·식단 챙김. 초보 크루의 든든한 길잡이." },
  { name:"지우", role:"기록 담당",   tag:"트레일러닝",    desc:"발자국 지도·후기 정리. 빠른 발로 능선을 스캔해요." },
];
...
// 초보 체크리스트
// 상황별 패킹 체크리스트 — 체크 상태는 localStorage에 프리셋별 저장
const CHECKLISTS = {
  "백패킹 기본": [
    "텐트 (박지 계절에 맞게)", "침낭 (내한온도 확인)", "에어매트 (R값 체크)",
    "백패킹 배낭 (40~60L)", "헤드랜턴 + 예비 배터리", "버너·코펠·연료",
    "식수 & 행동식", "보온 의류(레이어링)", "구급킷·상비약", "쓰레기봉투 (아니온듯 다녀갑니다)"
  ],
  "동계 백패킹": [
    "4계절 텐트 (강풍·스커트 대비)", "동계 침낭 (리밋 -10℃ 이하)", "R값 4+ 매트 (바닥 냉기 차단)",
    "동계용 이소가스 + 버너 (예열 필요)", "보온병 (뜨거운 물)", "장갑·비니·발라클라바",
    "아이젠·게이터 (설산)", "핫팩 넉넉히", "헤드랜턴 + 예비 배터리 (혹한엔 방전 빠름)",
    "여분 양말·베이스레이어", "비상 비비·구급킷", "쓰레기봉투 (아니온듯 다녀갑니다)"
  ],
  "섬 백패킹": [
    "배편 시간표·결항 여부 확인", "식수 넉넉히 (섬엔 물 구하기 어려움)", "행동식·비상식",
    "모기장·기피제 (여름)", "선크림·모자", "방수팩 (배·해변 물튐)",
    "일몰·일출 시간 체크", "타프·강풍 대비 팩다운", "여분 배터리 (충전 어려움)",
    "구급킷·상비약", "쓰레기 되가져갈 봉투 (아니온듯 다녀갑니다)"
  ],
  "오토캠핑": [
    "텐트·타프 + 팩·해머", "전기릴선 (전기사이트)", "난로 + 일산화탄소 경보기 (동계 필수)",
    "야전침대·이불·전기요", "아이스박스 + 얼음", "장작·화로대·토치",
    "버너·코펠·식기", "설거지 용품", "랜턴·스트링라이트",
    "의자·테이블", "구급킷·상비약", "분리수거 봉투 (아니온듯 다녀갑니다)"
  ],
};
const CHECKLIST = CHECKLISTS["백패킹 기본"];   // 구버전 호환
